...
// The app ships with a safe default Supabase configuration, so the client is
// available for all data helpers. Keep the singleton typed for callers that
// already handle request-level errors.
export const supabase: SupabaseClient = supabaseState.client as SupabaseClient;
